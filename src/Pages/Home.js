                ...
                <Offcanvas.Body>
                    ...
                    <div className='mt-3'>
                        ...
                        <div>
                            ...
                            }} placeholder='Min Price' className='rounded placeholder:text-red-300 font-bold me-3 border px-3 w-32 h-14' />

                            <input type='number' onChange={(e) => {
                                setValueMax(+e.target.value)
                            }} placeholder='Max Price' className='rounded placeholder:text-red-300 me-1 font-bold border px-3 w-32 h-14' />

                            <Button className='mt-2' onClick={() => {
                                const listTest = []
                                products.filter(product => {
                                    +product.price >= +valeuMinPrice & +product.price <= +ValueMax && listTest.push(...[product])
